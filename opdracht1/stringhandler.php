	 ...
	 <body>
		...
		<div class="wrapper">
			<form method="GET" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<fieldset>
				 <legend>Miguel Heijmans GD1B</legend>
			...
			<ul>
					...
					<li class="showSpaces">String 3 is de concatenation van string 1 en string 2:  <?php  echo "$input3 ";  ?> </li>
					<li>De lengte van string 3 is: <?php   echo strlen($input3); ?> </li>
					<li>Zoeken naar spaties :     <?php   echo  $input4 = "Er zit een spatie op positie ".strpos($input3, " ", 0);   ?> </li>
					<li>Zoeken naar @ :     <?php   echo  $input4 = "Er zit een @ op positie ".strpos($input3, "@", 0); ;   ?> </li>
					<li>Zoeken naar ".": Er zit een "." op positie <?php   echo  $input4 = strpos($input3, ".", 0); ;   ?> </li>
					<li class="showSpaces">Zoek naar substring "PHP" vervang dit door "NodeJS":  <?php  echo str_replace("PHP", "NodeJS", $input3);  ?> </li>
					<li class="showSpaces">Wijzig de eerste letter van string 3 naar hoofdletter:  <?php  echo ucfirst($input3);  ?> </li>
					<li class="showSpaces">Alles in hoofdletters:  <?php  echo strtoupper($input3);  ?> </li>
